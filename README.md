...
A more detailed description of how the program works is given in [Description.md](Description.md).

# HOW TO USE
In a Linux environment with g++ installed, in a terminal in a directory containing the [banker.cpp](banker.cpp) and [input.txt](input.txt) files, the program may be compiled by running the following command:
```
