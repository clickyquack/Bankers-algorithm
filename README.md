# Banker's Algorithm
This is a C++ demonstration of the banker's algorithm as used for deadlock avoidance. In the default example case used, there are 5 processes and 3 resource types.
